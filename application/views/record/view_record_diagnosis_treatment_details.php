                ...
                <table id="other_cancer_pathology_section">
                    ...
                    <tr>
                        <td>
                            ...
                            <?php echo form_dropdown('other_pathology_tissue_site[]', $patient_cancer_site_lists, $other_cancer['tissue_site'], 'id="cancer_site" preload_val="'.$other_cancer['tissue_site'].'"'); ?>
                        </td>
                        <td>
                            <?php echo $other_pathology_path_report_type; ?>: <br />
                            <?php echo form_dropdown('other_pathology_path_report_type[]', $pathology_path_report_type_lists, $other_cancer['type_of_report'], 'id="pathology_path_report_type_lists" preload_val="'.$other_cancer['type_of_report'].'"'); ?>
                        </td>
                        <td>
...
<!--                        <td>
                ...
                <input type="hidden" name="patient_other_pathology_id[]" value="<?php print $other_cancer['patient_pathology_id']; ?>"/>
                <input type="hidden" name="patient_other_cancer_treatment_id[]" value="<?php print $other_cancer['patient_cancer_treatment_id']; ?>"/>
                </table>
                <?php endforeach; ?>
            </div>
            <?php echo form_fieldset_close(); ?>	

<div class="container" id="add_record_div">
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <?php
                    $data = array(
                        'name' => 'double_consent_detail',
                        'id' => 'double_consent_detail',
                        'rows' => '3',
                        'cols' => '7'
                    );
    ...
    <div class="container" id="add_record_form_section_mammo_ultrasound">
        ...
        <table id="mammo_ultrasound_second_section_1">
            <tr>
                ...
                <td>
                    <input type="button" value="Add more ultrasound details" onClick="window.parent.addUltrasoundDetailsInput('add_record_form_section_mammo_ultrasound');
                            window.parent.calcHeight();">
                </td>
            </tr>
        </table>
    ...
    <div class="container" id="add_record_form_section_mammo_MRI">
        ...
        <table id="mammo_MRI_second_section_1">
            <tr>
                ...
                <td>
                    <input type="button" value="Add more MRI details" onClick="window.parent.addMRIDetailsInput('add_record_form_section_mammo_MRI');
                            window.parent.calcHeight();">
                </td>
            </tr>
        </table>
    ...
    <div class="container" id="add_record_form_section_mammo_benign_cyst_surgery">
        ...
        <table id="mammo_fifth_section_1">
            ...
            <tr>
                ...
                <td>
                    <input type="button" value="Add more details" onClick="window.parent.addLumpCystDetailsInput('add_record_form_section_mammo_benign_cyst_surgery');
                            window.parent.calcHeight();">
                </td>
            </tr>
        </table>
    ...
    <div class="container" id="add_record_form_section_mammo_other_screenings">
        ...
        <table id="mammo_other_screenings_section_1">
            ...
            <tr>
                ...
                <td>
                    <input type="button" value="Add more screening details" onClick="window.parent.addScreeningDetailsInput('add_record_form_section_mammo_other_screenings');
                            window.parent.calcHeight();">
                </td>
            </tr>
        </table>
    ...
    <div class="container" id="add_record_form_section_cancer">
        ...
        <table id="cancer_section_1">
            ...
            <td>
                <input type="button" value="Add more cancer details" onClick="window.parent.addCancerDetailsInput('add_record_form_section_cancer');
                            window.parent.calcHeight();">
            </td>
            </tr>
        </table>
    ...
    <div class="container" id="add_record_form_section_cancer_two">
        ...
        <table id="cancer_second_section_three_1">
            ...
            <tr>
                ...
                <td>
                    <input type="button" value="Add more cancer treatment" onClick="window.parent.addCancerTreatmentInput('add_record_form_section_cancer_two');
                            window.parent.calcHeight();">
                </td>
            </tr>
        </table>
    ...
    <div class="container" id="add_record_form_section_cancer_three">
        ...
        <table id="cancer_second_section_five_1">
            <tr>
                ...
                <td>
                    <input type="button" value="Add more cancer recurrence treatment" onClick="window.parent.addCancerRecurrenceInput('add_record_form_section_cancer_three');
                            window.parent.calcHeight();">
                </td>
            </tr>
        </table>

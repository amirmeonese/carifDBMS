    ...
    <div class="container" id="add_record_form_section_lifestyle">
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <?php echo form_dropdown('self_image_at_7years', $self_image_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
                    <?php echo $self_image_at_18years; ?>: 
                    <?php echo form_dropdown('self_image_at_18years', $self_image_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
                    <?php echo $self_image_now; ?>: 
                    <?php echo form_dropdown('self_image_now', $self_image_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
            </tr>
        </table>
        <div height="30px">&nbsp;</div>
        <table>
            ...
            <tr>
                <td>
                    Strenuous Exercise: 
                    <?php echo form_dropdown('pa_at_childhood', $pa_activities_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
                    Moderate Exercise: 
                    <?php echo form_dropdown('pa_at_adulthood', $pa_activities_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
                    Gentle Exercise: 
                    <?php echo form_dropdown('pa_now', $pa_activities_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
            </tr>
            <tr>
...
\                    <?php echo form_input(array('name' => 'total_smoked_years', 'value' => $patient_detail['total_smoked_years']))?>
            ...
            <tr>
                <td>
                    ...
                    <?php echo form_dropdown('cigarettes_count_at_teen', $cigarettes_average_count_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
                    <?php echo $cigarettes_count_at_twenties; ?>:  <br />
                    <?php echo form_dropdown('cigarettes_count_at_twenties', $cigarettes_average_count_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
                    <?php echo $cigarettes_count_at_thirties; ?>:  <br />
                    <?php echo form_dropdown('cigarettes_count_at_thirties', $cigarettes_average_count_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
            </tr>
            <tr>
                <td>
                    <?php echo $cigarettes_count_at_forties; ?>: <br />
                    <?php echo form_dropdown('cigarettes_count_at_forties', $cigarettes_average_count_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
                    <?php echo $cigarettes_count_at_fifties; ?>:  <br />
                    <?php echo form_dropdown('cigarettes_count_at_fifties', $cigarettes_average_count_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
                    <?php echo $cigarettes_count_at_sixties_and_above; ?>:  <br />
                    <?php echo form_dropdown('cigarettes_count_at_sixties_and_above', $cigarettes_average_count_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
            </tr>
            <tr>
                <td>
                    <?php echo $cigarettes_count_one_year_before_diagnosed; ?>:  <br />
                    <?php echo form_dropdown('cigarettes_count_one_year_before_diagnosed', $cigarettes_average_count_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
                    &nbsp;
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo form_dropdown('alcohol_average', $alcohol_drink_average_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo form_dropdown('coffee_average', $coffee_tea_drink_average_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
            </tr>
            <tr>
                <td id="label1">Tea</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo form_dropdown('tea_average', $coffee_tea_drink_average_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
            </tr>
            <tr>
                <td>
                    <?php echo $tea_type; ?>: <br />
                    <?php echo form_dropdown('tea_type', $tea_type_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo form_dropdown('soya_bean_average', $coffee_tea_drink_average_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
            ...
            <tr>
                <td>
                    ...
                    <?php echo form_dropdown('soya_products_average', $soya_products_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <?php echo form_dropdown('period_type', $period_type_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
            </tr>
            <tr>
                <td>
                    <?php echo $period_cycle_days; ?>: <br />
                    <?php echo form_dropdown('period_cycle_days', $period_cycle_days_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo form_dropdown('reason_period_stops', $reason_period_stops_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>
        ...
        <table id="infertility_section_1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo form_dropdown('gnc_treatment_name', $gnc_treatment_lists, $patient_detail['mother_cancer_name']); ?>
                </td>
                <td>

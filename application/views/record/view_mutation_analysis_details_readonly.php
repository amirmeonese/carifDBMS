<div class="container" id="add_record_div">
            ...
            <table id="mutation_section_1">
                ...
                <tr>
                    <td>
                        ...
                        <?php echo form_input(array('name' => 'date_test_ordered[]', 'value' => $list['date_test_ordered'], 'class' => 'datepicker', 'readonly' => 'true')); ?>
                    </td>
                    <td>
                        <?php echo $test_ordered_by; ?>:  <br />
                        <?php echo form_input(array('name' => 'test_ordered_by[]', 'value' => $list['ordered_by'], 'readonly' => 'true')) ?>
                    </td>
                    <?php if ($list['testing_result_notification_flag'] == 1) { ?>
                        <td>
                            <?php echo $testing_results_notification_flag; ?>:  
                            <?php echo form_checkbox(array('name' => 'testing_results_notification_flag[]', 'value' => $list['testing_result_notification_flag'], 'checked' => "checked", 'readonly' => 'true')) ?>
                        </td>
                    <?php } else { ?>
                        <td>
                            <?php echo $testing_results_notification_flag; ?>:  
                            <?php echo form_checkbox(array('name' => 'testing_results_notification_flag[]', 'value' => $list['testing_result_notification_flag'], 'readonly' => 'true')) ?>
                        </td>
                    <?php } ?>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo form_input(array('name' => 'investigation_project_batch[]', 'value' => $list['testing_batch'], 'readonly' => 'true')) ?>
                    </td>
                    <td>
                        <?php echo $investigation_project_date; ?>:  <br />
                        <?php echo form_input(array('name' => 'investigation_project_date[]', 'value' => $list['testing_date'], 'class' => 'datepicker', 'readonly' => 'true')); ?>
                    </td>
                    <td>
    ...
    <!--                    <td>
                    ...
                    <?php echo form_input(array('name' => 'investigation_gene_tested_other[]', 'value' => $list['investigation_gene_tested_other'], 'readonly' => 'true')) ?>
                    </td>-->
                    <td>
                ...
                <tr>
                    <td>
                        ...
                        <?php echo form_textarea(array('name' => 'investigation_test_reason[]', 'id' => 'investigation_test_reason', 'rows' => '3', 'cols' => '7', 'value' => $list['reasons'], 'readonly' => 'true')) ?>
                    </td>
                    <?php if ($list['new_mutation_flag'] == 1) { ?>
                        <td>
                            <?php echo $investigation_new_mutation_flag; ?>:  
                            <?php echo form_checkbox(array('name' => 'investigation_new_mutation_flag[]', 'value' => $list['new_mutation_flag'], 'checked' => "checked", 'readonly' => 'true')) ?>
                        </td>
                    <?php } else { ?>
                        <td>
                            <?php echo $investigation_new_mutation_flag; ?>:  
                            <?php echo form_checkbox(array('name' => 'investigation_new_mutation_flag[]', 'value' => $list['new_mutation_flag'], 'readonly' => 'true')) ?>
                        </td>
                    <?php } ?>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo form_textarea(array('name' => 'investigation_test_results_other_details[]', 'id' => 'investigation_test_results_other_details', 'rows' => '3', 'cols' => '7', 'value' => $list['investigation_test_results_other_details'], 'readonly' => 'true')) ?>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo form_input(array('name' => 'investigation_mutation_name[]', 'value' => $list['mutation_name'], 'readonly' => 'true')) ?>
                    </td>
                    </td>
                    <td>
                        <?php echo $investigation_mutation_type; ?>: </br>
                        <?php echo form_input(array('name' => 'investigation_mutation_type[]', 'value' => $list['mutation_type'], 'readonly' => 'true')) ?>
                    </td>
                </tr>
                <tr>
                    <td>
                        <?php echo $investigation_exon; ?>: </br>
                        <?php echo form_input(array('name' => 'investigation_exon[]', 'value' => $list['exon'], 'readonly' => 'true')) ?>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <?php echo form_input(array('name' => 'investigation_report_date[]', 'value' => $list['report_date'], 'class' => 'datepicker', 'readonly' => 'true')) ?>
                    </td>
                    <td>
                        <?php echo $investigation_date_notified; ?>:  <br />
                        <?php echo form_input(array('name' => 'investigation_date_notified[]', 'value' => $list['date_client_notified'], 'class' => 'datepicker', 'readonly' => 'true')) ?>
                    </td>
                </tr>
                <tr>
                    <?php if ($list['is_counselling_flag'] == 1) { ?>
                        <td>
                            ...
                            <?php echo form_checkbox(array('name' => 'mutation_is_counselling_flag[]', 'value' => $list['is_counselling_flag'], 'checked' => "checked", 'readonly' => 'true')) ?>
                        </td>
                    <?php } else { ?>
                        <td>
                            <?php echo $mutation_is_counselling_flag; ?>:  
                            <?php echo form_checkbox(array('name' => 'mutation_is_counselling_flag[]', 'value' => $list['is_counselling_flag'], 'readonly' => 'true')) ?>
                        </td>
                    <?php } ?>
                    <td>
                        <?php echo $investigation_test_comment; ?>:  <br />
                        <?php echo form_textarea(array('name' => 'investigation_test_comment[]', 'id' => 'investigation_test_comment', 'rows' => '3', 'cols' => '7', 'value' => $list['comments'], 'readonly' => 'true')) ?>
                    </td>
                    <?php if ($list['is_counselling_flag'] == 1) { ?>
                        <td>
                            <?php echo $investigation_conformation_attachment; ?>: 	
                            <?php echo form_checkbox(array('name' => 'investigation_conformation_attachment[]', 'value' => $list['conformation_attachment'], 'checked' => "checked", 'readonly' => 'true')) ?>
                        </td>
                    <?php } else { ?>
                        <td>
                            <?php echo $investigation_conformation_attachment; ?>: 	
                            <?php echo form_checkbox(array('name' => 'investigation_conformation_attachment[]', 'value' => $list['conformation_attachment'], 'readonly' => 'true')) ?>
                        </td>
                    <?php } ?>
                    <td>

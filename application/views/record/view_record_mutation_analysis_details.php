            ...
            <table id="mutation_section_1">
                ...
                <tr>
                    <td>
                        ...
                        <?php echo form_input(array('name' => 'date_test_ordered[]', 'value' => $list['date_test_ordered'] == '' ? ''  : date('d-m-Y', strtotime($list['date_test_ordered'])),'class' => 'datepicker')); ?>
                    </td>
                    <td>
               ...
               <?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo form_input(array('name' => 'investigation_project_date[]', 'value' => $list['testing_date'] == '' ? ''  : date('d-m-Y', strtotime($list['testing_date'])), 'class' => 'datepicker')); ?>
                    </td>
                    <td>
               ...
               <?php } else {?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo form_input(array('name' => 'investigation_report_date[]', 'value' => $list['report_date'] == '' ? ''  : date('d-m-Y', strtotime($list['report_date'])), 'class' => 'datepicker')) ?>
                    </td>
                    <td>
                        <?php echo $investigation_date_notified; ?>:  <br />
                        <?php echo form_input(array('name' => 'investigation_date_notified[]', 'value' => $list['date_client_notified'] == '' ? ''  : date('d-m-Y', strtotime($list['date_client_notified'])), 'class' => 'datepicker')) ?>
                    </td>
                </tr>
                <tr>

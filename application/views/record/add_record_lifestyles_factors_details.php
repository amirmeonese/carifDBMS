<div class="container" id="add_record_div">
    ...
    <div class="container" id="add_record_form_section_lifestyle">
		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<?php echo form_input('soya_bean_average'); ?>
				</td>
				<td>
					<?php echo $soya_products_flag; ?>: 
					<?php echo form_dropdown('soya_products_flag', $coffee_tea_drink_average_lists); ?>
				</td>
			</tr>
			<tr>
				<td>
		...
		<table id="pregnancy_section_1">
			...
			<tr>
				<td>
					<input type="button" value="Add more pregnancy details" onClick="window.parent.addPregnancyInput('add_record_form_section_lifestyle');window.parent.calcHeight();">
				</td>
				<td>
					&nbsp;
				</td>
		...
		<table id="infertility_section_1">
			<tr>
				...
				<td>
					...
					<?php echo form_input('infertiity_treatment_details'); ?>
				</td>
				<td>&nbsp;</td>
			<tr>
				<td>

    ...
    <div class="container" id="add_record_form_section_studies">
		...
		<table>
			...
			<tr>
                ...
                <td>
                   <?php  
						$conformationfileData1 = array('name' => 'conformation_file_url', 'class' => 'file'); // set your file and class for the image
						echo form_upload($conformationfileData1); // upload the data here the image that user has selected.
					?>
                </td>
                </td>
				 &nbsp;

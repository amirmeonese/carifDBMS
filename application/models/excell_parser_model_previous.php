    ...
    function excell_file_parser($filePath) {
        ...
        foreach ($loadedSheetNames as $sheetIndex => $loadedSheetName) {
            ...
            if (!$abort)
                if ($loadedSheetName == 'Personal') {
                    ...
                    foreach ($sheet->getRowIterator() as $row) {
                        ...
                        if (!$name_validator) {
                            echo '<h2>patient_given_name is not in appropriate format at Personal</h2>'.' row '.$i;
                            $abort = TRUE;
                            break;
                        }
                    ...
                    foreach ($sheet->getRowIterator() as $row) {//echo 'from Family';
                        ...
                        foreach ($cellIterator as $key => $cell) {
                            ...
                            if ($key == 1 && $cell_value != NULL) {
                                $array_relationship_type[] = trim(strtoupper($cell_value));
                            }
                            ...
                            if ($key == 14 && $cell_value == NULL)
                                ...
                                $array_cancer_name_Family[] = trim(strtoupper($cell_value));
                        }
		    ...
		    $temp_result_relationship = null;
                    ...
                    $array_IC_no_Diagnosis = array();
                    $array_cancer_site_name_Diagnosis =array();
                    $array_studies_name = array();
                    $array_studies_name = null;
                    $array_treatment_name_Diagnosis = array();
                    $array_treatment_name_Diagnosis = null;
                    $array_cancer_name_Diagnosis = array();
                    ...
                    foreach ($sheet->getRowIterator() as $row) {
                        ...
                        foreach ($cellIterator as $key => $cell) {
                            ...
                            if ($key == 2 && $cell_value != NULL) {
                                $array_cancer_name_Diagnosis[] = trim(strtoupper($cell_value));
                            }

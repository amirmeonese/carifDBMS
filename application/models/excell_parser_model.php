    ...
    function excell_file_parser($filePath) {
        ...
        //checking ends at above
         if (!$abort) {
          ...
          'patient_ic_no' => $temp4[0],
          'patient_studies_id' => $patient_studies_id,
          'date_of_first_mammogram' => $temp4[2],
          ...
          if ($key == 3 || $key == 10 || $key == 14 || $key == 15 || $key == 16) {
          if ($cell_value != NULL) {
          $cell_value = date('Y-m-d', strtotime(str_replace('/', '-', $cell_value)));
          }
          }
          ...
          'diagnosis' => $temp8[13],
          'due_date' => $temp8[14],
          'reminder_sent_date' => $temp8[15],
          'surveillance_done_date' => $temp8[16],

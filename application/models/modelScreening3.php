        ...
        $data_patient_risk_reducing_surgery_update = array();
                    ...
                    foreach ($sheet->getRowIterator() as $row) {
                       ...
                       if(strpos(strtoupper($temp6[5]), 'Y') !== false)
                        ...
                        {
                            $patient_risk_reducing_surgery_id = $this->excell_sheets_model->get_patient_risk_reducing_surgery_id($patient_studies_id);
                            $data_patient_risk_reducing_surgery_update[] = array(
                            'patient_risk_reducing_surgery_id' => $patient_risk_reducing_surgery_id,   
                        ...
                        {
                            $patient_risk_reducing_surgery_lesion_id = $this->excell_sheets_model->get_patient_risk_reducing_surgery_lesion_id($patient_risk_reducing_surgery_id);
                            $data_patient_risk_reducing_surgery_lesion_update[] = array(
                            'patient_risk_reducing_surgery_lesion_id' => $patient_risk_reducing_surgery_lesion_id,    
                            'patient_risk_reducing_surgery_id' => $patient_risk_reducing_surgery_id,
                        ...
                        {
                            $patient_risk_reducing_surgery_complete_removal_id = $this->excell_sheets_model->get_patient_risk_reducing_surgery_complete_removal_id($patient_risk_reducing_surgery_id,$non_cancerous_site_id);
                            $data_patient_risk_reducing_surgery_complete_update[] = array(
                            'patient_risk_reducing_surgery_complete_removal_id' => $patient_risk_reducing_surgery_complete_removal_id,    
                            'patient_risk_reducing_surgery_id' => $patient_risk_reducing_surgery_id,
                            'non_cancerous_site_id' => $non_cancerous_site_id,
                    ...
                    //print_r($data_patient_risk_reducing_surgery_lesion);
                    //print_r($data_patient_risk_reducing_surgery_complete_removal);
                    ...
                    {
                        $id_patient_risk_reducing_surgery = $this->db->update_batch('patient_risk_reducing_surgery',$data_patient_risk_reducing_surgery_update, 'patient_risk_reducing_surgery_id');
                        if ($id_patient_risk_reducing_surgery > 0)
                    ...
                    if(sizeof($data_patient_risk_reducing_surgery_lesion) > 0 && sizeof($data_patient_risk_reducing_surgery_complete_removal) > 0)
                    {
                        ...
                        //print_r($data_patient_risk_reducing_surgery_lesion[$key]);echo '<br/>';
                    ...
                    {
                        $id_patient_risk_reducing_surgery_lesion = $this->db->update_batch('patient_risk_reducing_surgery_lesion',$data_patient_risk_reducing_surgery_lesion_update,'patient_risk_reducing_surgery_lesion_id');
                    ...
                    {
                        $id_patient_risk_reducing_surgery_complete_removal = $this->db->update_batch('patient_risk_reducing_surgery_complete_removal',$data_patient_risk_reducing_surgery_complete_update,'patient_risk_reducing_surgery_complete_removal_id');
                        if ($id_patient_risk_reducing_surgery_complete_removal > 0)

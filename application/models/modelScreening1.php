...
//                    $data_patient_breast_screening_update = null;
                    ...
                    //print_r($data_patient_breast_screening_update);
                }
                else
                {
                    $data_patient_breast_screening[] = array(
            ...
            if(sizeof($data_patient_breast_screening_update) > 0)
                {
                    $id_patient_breast_screening_update = $this->db->update_batch('patient_breast_screening',$data_patient_breast_screening_update,'patient_breast_screening_id');
                    if ($id_patient_breast_screening_update > 0)
                        echo 'Data updated succesfully at patient_breast_screening table';
                    else
                        echo 'Updated Data at patient_breast_screening table';
                    echo '<br/>';
                    $data_patient_breast_screening_update = null;
                }
